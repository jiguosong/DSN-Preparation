...
\begin{frame}
  ...
  \begin{textblock}{110}(8,14)
    ...
    \only<11>{\includegraphics[width=1\linewidth]{SuperGlueFigs/design/dsn/design_1_3_0}}%
    \only<12>{\includegraphics[width=1\linewidth]{SuperGlueFigs/design/dsn/design_1_3_1}}%
    \only<13>{\includegraphics[width=1\linewidth]{SuperGlueFigs/design/dsn/design_1_3_2}}%
    \only<14-15>{\includegraphics[width=1\linewidth]{SuperGlueFigs/design/dsn/design_1_3}}%
  \end{textblock}
  \begin{textblock}{52}(72,15)
    \only<2-8>{{\it Descriptor}}
    \begin{itemize}
    ...
    \end{itemize}
    \only<11->{{\it Interface Function Types}}
    \begin{itemize}
